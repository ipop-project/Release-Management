...
SCALE_TEST_DIR="Release/Management/ipop-scale-test"
SCALE_TEST_URL="https://github.com/ipop-project/$SCALE_TEST_DIR"
CONTROLLERS_URL="https://github.com/ipop-project/Controllers"
TINCAN_URL="https://github.com/ipop-project/Tincan"
VISUALIZER="F"

#TODO Remove after merging feature with master
TESTING="T"
